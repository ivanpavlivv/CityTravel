  ...
  return (
    <>
      ...
      <ButtonGroup variant="contained" sx={{ mt: 4 }}>
        <Button onClick={() => handleError("cities/not-found")}>
          Not found
        </Button>
        <Button onClick={() => handleError("cities/bad-request")}>
          Bad request
        </Button>
        <Button onClick={() => handleError("cities", "post")}>
          Validation error
        </Button>
        <Button onClick={() => handleError("cities/server-error")}>
          Server error
        </Button>
        <Button onClick={() => handleError("cities/unauthorised")}>
          Unauthorised
        </Button>
      </ButtonGroup>
